...
class ListingController extends Controller
{
    ...
    public function auto(Request $request, $param = null)
    {
        ...
        if ($request->ajax()) {
            ...
            $city_name_data = $this->getCityByZipCodeOnCache($zip_code_inform);
            $calculate_distance = $this->calculateDistanceData($zip_code_inform);
...
// dd($cacheFilePath);
            ...
            $target_condition = !empty($request->input('autoWebConditionCheckbox'))
                ...
                // Apply filters
                $filteredInfo = $info->filter(function ($data) use ($target_make, $target_model, $target_body, $target_fuel, $target_exterior,$target_interior,$target_drivetrain,$target_transmission, $target_condition, $min_price,$max_price,$min_mileage,$max_mileage,$min_year,$max_year,) {
