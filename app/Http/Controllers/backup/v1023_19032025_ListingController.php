...
// dd($cacheFilePath);
            ...
            $target_condition = !empty($request->input('autoWebConditionCheckbox'))
                ...
                // Apply filters
                $filteredInfo = $info->filter(function ($data) use ($target_make, $target_model, $target_body, $target_fuel, $target_exterior,$target_interior,$target_drivetrain,$target_transmission, $target_condition, $min_price,$max_price,$min_mileage,$max_mileage,$min_year,$max_year,$latitude_infor,$longitude_infor,$zip_radios_inform) {
                    ...
                    if (!empty($target_fuel) && !in_array(strtolower($data['fuel']), $target_fuel)) {
                        return false;
                    }
                    ...
                    if (!empty($target_condition) && !in_array(strtolower($data['transmission']), $target_condition)) {
                        return false;
                    }
                ...
                $message = '';
                $messageData = 'This is show from Cache';
