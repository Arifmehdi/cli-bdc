...
class AddDallasCache extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'add-dallas-cache';
     ...
     * @var string
     */
    protected $description = 'Cache the Dallas Zip Code data';
    ...
    public function handle()
    {
        ...
        $cacheFilePath = storage_path('app/dallas_county.json'); // File path for caching
        ...
        $this->info('Dallas data cached successfully in file: ' . $cacheFilePath);
        // 78228
    }
}
