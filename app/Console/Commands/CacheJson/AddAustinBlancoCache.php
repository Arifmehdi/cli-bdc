...
class AddAustinBlancoCache extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'add-austin-blanco-cache';
     ...
     * @var string
     */
    protected $description = 'Cache the Austin - Blanco Zip Code data';
    ...
    public function handle()
    {
        ...
        $zip_code = [
            '78606', '78635', '78636', '78663'
        ];

        $chunkSize = 1000; // Adjust as needed
        $cacheFilePath = storage_path('app/blanco_county.json'); // File path for caching
        ...
        $this->info('Austin - Blanco data cached successfully in file: ' . $cacheFilePath);
        // 78228
    }
}
