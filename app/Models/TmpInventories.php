...
class TmpInventories extends Model
{
    ...
    protected $fillable = ['dealer_id','deal_id','zip_code','latitude','longitude','detail_url','img_from_url','local_img_url','local_img_url','vehicle_make_id','title','year','make','model','vin','price','price_rating','miles','type','modelNo','trim','stock','engine_details','transmission','body_description','vehicle_feature_description','vehicle_additional_description','fuel','drive_info','drive_info','mpg', 'mpg_city','mpg_highway','exterior_color','interior_color','star','created_date','stock_date_formated','user_id','payment_price','price_history','body_formated','is_feature','status','inventory_status','batch_no'];
