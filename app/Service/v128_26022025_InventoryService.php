...
{
    protected $cacheDuration = 60; // Cache duration in minutes
    ...
    {
        $cacheKey = $this->generateCacheKey($request, $id);

        return Cache::remember($cacheKey, $this->cacheDuration, function () use ($request, $id) {
    ...
    protected function generateCacheKey($request, $dealer_id)
    {
        // Generate a unique cache key based on the request parameters
        return 'inventory_filter_' . md5(serialize($request->all()) . $dealer_id);
    }
}
