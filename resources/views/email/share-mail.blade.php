                        ...
                        <tbody>
                            <tr>
                                <td id="m_-6213805131743743389x_30955800m_7214636301576423636m_-8383321887939428501Logo"
                                    ...
                                    <img width="80" alt="bestdreamcar.com"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td align="center"
                                                    ...
                                                    valign="top">Share Listing Details<br></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td align="center"
                                                    ...
                                                    valign="top"><b>Source:</b> <a
                                                        href="{{route('home')}}"
                                                        target="_blank"
                                                        data-saferedirecturl="https://www.google.com/url?q=http://carsforsale.com&amp;source=gmail&amp;ust=1698817594175000&amp;usg=AOvVaw0Tf5icET8_-3CQ31R-Qxbt">bestdreamcar.com</a><br>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                style="margin:0;padding:0;font-family:&quot;Helvetica Neue&quot;,Helvetica,Arial,sans-serif;color:#575757;line-height:150%;margin-bottom:0;padding:30px 50px 10px 50px;font-weight:bold;font-size:22px">Hi {{$data['name']}}</td>
                                                            </tr>
                                                            <tr>
                                                                <td  colspan="2" style="margin:0;padding:0;font-family:&quot;Helvetica Neue&quot;,Helvetica,Arial,sans-serif;color:#575757;line-height:150%;margin-bottom:0;padding:30px 50px 10px 50px;font-weight:bold;font-size:15px;">
                                                                    I hope this email finds you well. I wanted to share with you a car listing that I think might interest you. Below are the details of the car<br></td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <b>Year</b>: {{ $data['year'] }}<br> <b>Make</b>:
                                                                    {{ $data['make'][0] }}<br>
                                                                ...
                                                                <td align="right"
                                                                    ...
                                                                    <img id="m_-62138051317437433891698726120623100001_imgsrc_url_2"
                                                                        style="width:210px;height:158px;margin:0px 0px 0px 30px"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <i>{{ $data['description'] }}</i><br><br/><br/><br/>
                                                                    <p>You can view more details or inquire about this car directly by visiting our website at <a href="{{route('auto')}}">Click Here</a></p><br/><br/>
                                                                    <p>If you are interested to know more details,
                                                                    please let us know <a href="{{ route('contact') }}">
                                                                        <br> Contact Us</a> </p> </b></span></span></span>
                                                                </td>
                                                            </tr>
