...
<!-- practising practising practising practising practising practising practising practising practising practising  -->
        ...
        <div class="hide-on-laptop hide-on-phone card shadow-sm mx-auto " style="max-width: 31rem; position: relative;">
            ...
            <div class="card-body">
                ...
                <h5 class="card-title mt-2">
                    ...
                    @php
                    $make_title = $inventory->make . ' ' . $inventory->model . ' ' . ($inventory->trim == 'N/A' ? '' : $inventory->trim );
                    @endphp
                ...
                <!-- Price -->
                <h3 class="fw-bold text-dark" style="font-size:2.5rem">{{ $inventory->price_formate }} <strong style="font-weight:300px; font-size:12px" id="strong_monthly_pay">$30 /mo*</strong></h3>
                ...
                <div style="border-radius:6px; box-shadow: rgba(100, 100, 111, 0.2) 0px 4px 7px 0px;"
                    ...
                    <div style="background: white; height:auto;" class="widget">
                        <div class="financial-detail-card">
                            ...
                            <h2 style="display:block; text-align:center; color:white; font-weight:500">
                                $<span class="ms-1" id="calculator_monthly_pay">{{ number_format($global_cus_monthly_payment) }}</span>
                            </h2>
                            <p class="p-0 m-0"
                                style="font-size:16px; display:block; text-align:center; color:rgb(235, 231, 231)"
                                ...
                                <ul>
                                    ...
                                    <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                        <div class="row">
                                            ...
                                            <div class=" col-lg-6 col-sm-6 col-md-6">
                                                <label style="margin-top:15px">Sales Tax 8%</label>
                                                <input type="text"
                                                    class="form-control common_calculator mb-2"
                                                    placeholder="Sales Tax 8%" value="9"
                                                    id="sales_tax">
                                            </div>
                                        </div>
                                    </li>
    ...
    <section class="d-block d-md-none">
        <h3 class="mb-5 mt-6">Recommended For You 05</h3>
        <!--Related Posts-->
        <div id="myCarousel5" class="owl-carousel owl-carousel-icons3">
            @forelse ($relateds as $item)
            <div class="item">
    ...
    <div id="cardSlider" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        ...
        <div class="carousel-item active">
          <div class="row">
            <!-- Card 1 -->
            @forelse ($relateds as $index => $carData)
            @php
                $imageArray = explode(',', $carData->local_img_url);
                $image = str_replace(['[', ' ', "'", ']'], '', $imageArray[0]);
                ...
                $image_obj = $carData->local_img_url;
                $image_splice = explode(',', $image_obj);
                $image = str_replace(['[', ' ', "'", ']'], '', $image_splice[0]);
            ...
            <div class="col-md-3">
              <div class="card position-relative shadow-sm">
                ...
                <a href="{{ route('auto.details', ['vin' => $vin_string_replace, 'param' => $route_string]) }}">
                    <img src="{{ asset('frontend/') }}/{{ $image }}" class="card-img-top" alt="Car Image">
                </a>
                <div class="card-body">
                <small>
                ...
                <a href="{{ route('auto.details', ['vin' => $vin_string_replace, 'param' => $route_string]) }}">
                  ...
                  <p class="mileage">{{ number_format($latest->miles) . ' miles' }}</p>
