...
$autoMobileTypeCheckbox = $searchData['newautoMobileTypeCheckbox'] ?? [];
$selectedMake = $searchData['newsecondFilterMakeInputNew'] ?? '';
$mobileColorFilter = $searchData['newmobileColorFilter'] ?? [];
$webColorFilter = $searchData['newwebColorFilter'] ?? [];
$autoMobileTransmissionCheckbox = $searchData['newautoMobileTransmissionCheckbox'] ?? [];
$autoWebTransmissionCheckbox = $searchData['newautoWebTransmissionCheckbox'] ?? [];
$autoWebDriveTrainCheckbox = $searchData['newautoWebDriveTrainCheckbox'] ?? [];
$autoMobileFuelCheckbox = $searchData['newautoMobileFuelCheckbox'] ?? [];
$autoWebFuelCheckbox = $searchData['newautoWebFuelCheckbox'] ?? [];
$webBodyFilter = isset($searchData['newwebBodyFilter']) ? (array) $searchData['newwebBodyFilter'] : [];
$mobileBody = isset($searchData['newmobileBody']) ? (array) $searchData['newmobileBody'] : [];
// vehicles fuel code Start Here **********************************
...
$vehicles_fuel = ['Gas', 'Diesel', 'Electric', 'Hybrid', 'Flex Fuel','Compressed Natural Gas'];
...
// $conditions = ['usedType', 'certifiedType', 'option2'];
// $allConditionsChecked = empty($autoMobileTypeCheckbox) || !in_array(true, array_map(function($condition) use ($autoMobileTypeCheckbox) {
//     return in_array($condition, (array)$autoMobileTypeCheckbox);
// }, $conditions));

// $usedChecked = in_array('usedType', (array)$autoMobileTypeCheckbox) ? 'checked' : '';
// $certifiedChecked = in_array('certifiedType', (array)$autoMobileTypeCheckbox) ? 'checked' : '';
// $allChecked = $allConditionsChecked ? 'checked' : '';
...
@section('og_title', 'Autos || New Cars, Used Cars, Car News, Car Reviews and Pricing listing | Best Dream car' ??
...
@section('twitter_title', 'Autos || New Cars, Used Cars, Car News, Car Reviews and Pricing listing | Best Dream car' ??
                ...
                <div class="col-xl-3 col-lg-3 col-md-12 auto-filter-sidebar">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div style="margin-top:-10px;" class="d-flex justify-content-between mb-2">
                            ...
                            <div style="display: flex; gap: 10px;" class="mb-2">
                                ...
                                <div style="flex: 1; display: flex; flex-direction: column;">
                                    ...
                                    <input class="form-control common_selector" id="web_location" type="text"
                                        name="weblocationNewInput" placeholder="Zip Code"
                                        value="">
                                </div>
                            </div>
                        ...
                        <div style="width:100%; padding-bottom: 38px; padding-left:27px" class="card-body pe-4 pt-2">
                            <div class="h6 text-center">
                                ...
                                <span id="price-range-display" class="count-item">$0 – $100,000+</span>
                            </div>
                    ...
                    <div style="margin-top:-10px" class="container p-0 mb-4">
                        <ul style="" class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li style="z-index:2;" class="nav-item" role="presentation">
                                <a style="font-size:14px; font-weight:600;" class="nav-link-web" id="profile-tab"
                                                    ...
                                                    <div
                                                        ...
                                                        <a href="javascript:void(0)"
                                                            ...
                                                            <img src="{{ asset('/frontend/assets/images/' . $image) }}"
                                                                class="img-fluid pt-3" alt="{{ $bodyType }} Image">
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-12">
                                    ...
                                    <div style="display: flex; gap: 10px;" class="mb-5">
                                        ...
                                        <div style="flex: 1; display: flex; flex-direction: column;">
                                            ...
                                            <input class="form-control mobile_common_selector" name="mobilelocation"
                                                type="text" id="mobile_location" placeholder="Zip Code"
                                                value="">
                                        </div>
                                    </div>
                                    ...
                                    {{--
                                    <div class="">
                                        <p style="font-weight:600; font-size:15px; color:rgb(82, 81, 81); margin-bottom:6px" class="">Condition</p>
                                    </div>
                                    ...
                                    <div class="card overflow-hidden mt-5">
                                        <!-- Loader Element -->
                                        <div id="loader_data_mobile"
                                            style="display: none;position: fixed;margin-left: 34%;top: 50%; z-index:99">
                                        ...
                                        <div style="margin-top:45px" class="container p-0 mb-4">
                                            <ul style="border-bottom:0.03px solid gray; background: linear-gradient(180deg, #fff 0, #fff 50%, #f7f7f7 80%, #f2f2f2);"
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <a style="font-size:15px" class="nav-link" id="profile-tab"
                                                        data-bs-toggle="tab" href="#body-card" role="tab"
                                                        aria-controls="profile" aria-selected="false">Body Style</a>
                                                </li>
                                    ...
                                    <div style="padding: 0; height: auto; margin-bottom: 155px" class="card-body">
                                        <div class="accordion accordion-flush" id="accordionFlushExample">
                                            <div class="accordion-item">
                                                <h4 style="border: 0.02px solid rgb(206, 205, 205);"
                                                    class="accordion-header" id="flush-headingOne">
    ...
    <div class="filter-btn-styel-auto">
        <div class="filter-all-btn">
            <button type="button" class="btn filter-option-auto1"
                data-url="{{ route('auto.new', ['clear' => 'newCar']) }}" id="newSearchBtn">
...
@push('js')
    ...
    <script>
        ...
        //***************** mobile color ajax code  start here *******************************
        ...
        $('#clearAllFilter,#mobile_newCar_clear').on('click', function() {
            var requestURL = window.location.href;
            var action = $(this).data('url');
            $('#clearAllFilter').text('Loading...');
            $('#mobile_newCar_clear').text('Loading...');
            // Clear session on the server
            $.ajax({
                url: action,
                method: "GET",
                success: function(response) {
                    if (response.success == 'clear') {
                        ...
                        window.location.href = window.location.pathname;
                        $('#mobile_newCar_clear').text('Clear All');
                        $('#clearAllFilter').text('Clear All');
                    }
                    $('#mobile_newCar_clear').text('Clear All');
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#searchFirstFilterMakeInput').select2();
            $('#searchFirstFilterModelInput').select2();
            ...
            $('#searchSecondFilterModelInput').on('select2:open', function(e) {
                focusSearchField(this);
            });

            $('#searchFirstFilterMakeInput').on('select2:open', function(e) {
                focusSearchField(this);
            });
            $('#searchFirstFilterModelInput').on('select2:open', function(e) {
                focusSearchField(this);
            });
    ...
    @include('frontend.website.layout.js.auto_new_list_js')
