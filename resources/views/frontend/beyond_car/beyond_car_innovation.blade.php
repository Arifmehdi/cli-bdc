...
@endpush
@php
$description = 'Cutting-edge car technology and EV innovations - Stay ahead with the latest automotive advancements from bestdreamcar.com';
@endphp
...
@section('og_title', 'Innovation | ' . app('globalSeo')['name'] ?? app('globalSeo')['og_title'])
...
@section('twitter_title', 'Innovation | ' . app('globalSeo')['name'] ?? app('globalSeo')['twitter_title'])
...
@section('title', 'Innovation | ' . app('globalSeo')['name'])
                    ...
                    @if($news->isNotEmpty())
                        <div class="row">
                            @foreach ($news as $key => $data)
                                ...
                                type="Innovation"
                                :route="route('frontend.research.beyondcar.article.details', ['categorySlug' => 'innovation','slug' => $data->slug])"
