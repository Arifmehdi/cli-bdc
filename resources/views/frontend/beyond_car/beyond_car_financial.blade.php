...
@endpush
@php
$description = 'Auto financing news and car buying tips - Get the best deals and understand market trends for your next vehicle purchase.';
@endphp
...
@section('og_title', 'Financial | ' . app('globalSeo')['name'] ?? app('globalSeo')['og_title'])
...
@section('twitter_title', 'Financial | ' . app('globalSeo')['name'] ?? app('globalSeo')['twitter_title'])
...
@section('title', 'Financial | ' . app('globalSeo')['name'])
@section('content')
    <style>
                    ...
                    @if($news->isNotEmpty())
                        <div class="row">
                            @foreach ($news as $key => $data)
                                ...
                                type="Financial"
                                :route="route('frontend.research.beyondcar.article.details', ['categorySlug' => 'financial','slug' => $data->slug])"
