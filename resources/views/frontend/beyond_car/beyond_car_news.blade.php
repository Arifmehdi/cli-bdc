...
@php
$description = 'Latest automotive news and updates - New model releases, industry trends, and market shifts from your trusted bestdreamcar.com experts.';
@endphp
...
@section('og_title', 'Beyond Car - News | ' . app('globalSeo')['name'] ?? app('globalSeo')['og_title'])
...
@section('twitter_title', 'Beyond Car - News | ' . app('globalSeo')['name'] ?? app('globalSeo')['twitter_title'])
...
@section('title', 'Beyond Car - News | ' . app('globalSeo')['name'])
...
@section('content')
    ...
    <!--Breadcrumb-->
    <section>
        <x-breadcrumb :slug="$slug" category="true" main="Beyond Car"  :route="route('frontend.beyondcar')" />
    </section>
    <!--/Breadcrumb-->
    {{-- sub menu start here  --}}
                    ...
                    @if($news->isNotEmpty())
                        <div class="row">
                            @foreach ($news as $key => $data)
                                ...
                                type="News"
                                {{-- :route="route('article.details', ['slug' => $data->slug])" --}}
                                :route="route('frontend.research.beyondcar.article.details', ['categorySlug' => 'news','slug' => $data->slug])"
                                :main="route('frontend.beyondcar.news')"
                                />
                            @endforeach
