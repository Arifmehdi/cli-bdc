...
@php
$description = 'Expert car buying advice and automotive opinions - Professional insights to help you make informed vehicle purchase decisions.';
@endphp
...
@section('og_title', 'Opinion | ' . app('globalSeo')['name'] ?? app('globalSeo')['og_title'])
...
@section('twitter_title', 'Opinion | ' . app('globalSeo')['name'] ?? app('globalSeo')['twitter_title'])
...
@section('title', 'Opinion | ' . app('globalSeo')['name'])
                    ...
                    @if($news->isNotEmpty())
                        <div class="row">
                            @foreach ($news as $key => $data)
                                ...
                                type="Opinion"
                                :route="route('frontend.research.beyondcar.article.details', ['categorySlug' => 'opinion','slug' => $data->slug])"
