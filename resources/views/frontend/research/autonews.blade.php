...
@php 
$description = 'Latest automotive industry news, new model releases, and market trends. Stay informed about the cars you love with bestdreamcar.com';
@endphp 
...
@section('og_title', 'Auto News | ' . app('globalSeo')['name'] ?? app('globalSeo')['og_title'])
...
@section('twitter_title', 'Auto News | ' . app('globalSeo')['name'] ?? app('globalSeo')['twitter_title'])
...
@section('title', 'Auto News | ' . app('globalSeo')['name'])
        ...
        <div class="container">
            <div class="row">
                ...
                <div style="width:100%" class="col-xl-12 col-lg-12 col-md-12 col-sm-6 col-xs-12 new-first-option">
                    @if($datas->count() > 1)
                        <h2 class="new-tit mb-4">{{$slug ?? 'News'}}</h2>
                    @endif
                    ...
                    @if($news->isNotEmpty())
                        <div class="row">
                            @foreach ($news as $key => $data)
                                ...
                                :route="route('frontend.research.review.autonews.details', ['categorySlug' => 'auto-news','slug' => $data->slug])"
                                :main="route('frontend.research.auto.news')"
                                />
                            @endforeach
