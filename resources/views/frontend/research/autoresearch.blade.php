...
@php
$description = 'Your complete car research hub - Explore auto news, buying guides, expert reviews, comparison tools, and FAQs. Make confident vehicle decisions with bestdreamcar.com trusted resources.';
@endphp
...
<section style="padding-top: 5px !important; padding-bottom:45px !important" class="">
    <div style="border-radius:5px; padding-bottom:25px" class="container">
        @if($news->count() > 1)
        <div class="text-center section-title center-block new-first-option">
            <h3 style="margin-top:55px" class="header-title">Auto News</h3>
            ...
            <div class="item">
                <div class="mb-0 card">
                    <div class="item7-card-img">
                        <a href="{{ route('frontend.research.review.autonews.details', ['categorySlug' => 'auto-news','slug' => $new->slug]) }}"></a>
                    ...
                    <div class="card-body p-4">
                        ...
                        @endphp
                        <a href="{{ route('frontend.research.review.autonews.details', ['categorySlug' => 'auto-news','slug' => $new->slug]) }}"
        ...
        <div class="col-md-12 text-end m-2" style="padding-right:3rem">
            <a href="{{ route('frontend.research.auto.news') }}" style="border-bottom:1px solid black;" ><strong>View more Auto News</strong></a>
        </div>
...
<section class="sptb bg-white">
    <div class="container">
        <div>
            @if($sels->count() > 1)
            <div class="resharch-content-title new-first-option">
                <h4 style="font-size:24px" class="mb-3 header-title">Tools & Advice</h4>
            </div>
            @endif
            @if($sels->isNotEmpty())
                ...
                <div class="row p-0" id="cars-containers">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-xs-12 mb-1">
                        <div style="width:100%" class="card">
                            <a href="{{ route('frontend.research.review.autonews.details', ['categorySlug' => 'tools-&-advice','slug' => $sel->slug])  }}" class="text-decoration-none">
                                <div class="">
                                    @if (isset($sel->img))
                                ...
                                <div class="mt-1 resh-tit p-3">
                                    ...
                                    <p style="height:80px" class="news-par">{{ $sub_title }}</p>
                                    <a class="mt-5 mb-0 res-more" href="{{ route('frontend.research.review.autonews.details', ['categorySlug' => 'tools-&-advice','slug' => $sel->slug])  }}"
                    ...
                    <div class="col-md-12 text-end m-2">
                        <a href="{{ route('frontend.research.tools.advice')}}" style="border-bottom:1px solid black" ><strong>View more Tools & Expert Device</strong></a>
                    </div>
                </div>
            </div>
            @endif
...
<section style="margin-top:-45px" class="sptb bg-white">
    <div class="container">
        <div>
            @if($shops->count() > 1)
            <div class="resharch-content-title new-first-option">
                <h4 style="font-size:24px" class="mb-3 header-title">Car Buying Advice</h4>
            </div>
            @endif
            ...
            <div class="col-md-12 m-0 p-0">
                <div class="row p-0" id="cars-containers">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-xs-12 mb-5">
                        ...
                        <div style="width:100%" class="card">
                            <a href="{{ route('frontend.research.review.autonews.details', ['categorySlug' => 'car-buying-advice','slug' => $shop->slug])  }}" class="text-decoration-none">
                                <div class="">
                                ...
                                <div class="mt-1 resh-tit p-3">
                                    ...
                                    <a class="mt-5 mb-0 res-more" href="{{ route('frontend.research.review.autonews.details', ['categorySlug' => 'car-buying-advice','slug' => $shop->slug])  }}"
                                        style="float:right; color:darkcyan">Read more <i
                                            class="fa fa-angle-right ms-1 res-more"></i></a>
                                </div>
                            </a>
                    ...
                    @endforeach
                    <div class="col-md-12 text-end m-2">
                        <a href="{{ route('frontend.research.car.buying.advice') }}" style="border-bottom:1px solid black" ><strong>View more Car Buying Advice</strong></a>
                    </div>
                </div>
            </div>
            @endif
...
<section style="margin-top:-45px" class="sptb bg-white">
    <div class="container">
        <div>
            @if($shops->count() > 1)
            <div class="resharch-content-title new-first-option">
                <h4 style="font-size:24px" class="mb-3 header-title">Car Tips</h4>
            </div>
            @endif
            ...
            <div class="col-md-12 m-0 p-0">
                <div class="row p-0" id="cars-containers">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-xs-12 mb-5">
                        ...
                        <div style="width:100%" class="card">
                            <a href="{{ route('frontend.research.review.autonews.details', ['categorySlug' => 'car-tips','slug' => $tip->slug ])  }}" class="text-decoration-none">
                                <div class="">
                                ...
                                <div class="mt-1 resh-tit p-3">
                                    ...
                                    <a class="mt-5 mb-0 res-more" href="{{ route('frontend.research.review.autonews.details', ['categorySlug' => 'car-tips','slug' => $tip->slug ])  }}"
                                        style="float:right; color:darkcyan">Read more <i
                                            class="fa fa-angle-right ms-1 res-more"></i></a>
                                </div>
                            </a>
                    ...
                    @endforeach
                    <div class="col-md-12 text-end m-2">
                        <a href="{{ route('frontend.research.car.tips') }}" style="border-bottom:1px solid black" ><strong>View more Car Tips</strong></a>
                    </div>
                </div>
            </div>
            @endif
