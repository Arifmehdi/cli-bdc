...
@php 
$description = 'Unbiased expert & owner reviews on new and used cars. Compare performance, reliability, and value before you buy.';
@endphp
...
@section('og_title', 'Review | ' . app('globalSeo')['name'] ?? app('globalSeo')['og_title'])
...
@section('twitter_title', 'Review | ' . app('globalSeo')['name'] ?? app('globalSeo')['twitter_title'])
...
@section('title', 'Review | ' . app('globalSeo')['name'])
                    ...
                    @if($news->isNotEmpty())
                        <div class="row">
                            @foreach ($news as $key => $data)
                                ...
                                type="Review"
                                {{-- :route="route('frontend.news.details', ['slug' => $data->slug])" --}}
                                :route="route('frontend.research.review.autonews.details', ['categorySlug' => 'review','slug' => $data->slug])"
