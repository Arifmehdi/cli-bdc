...
@php 
$description = 'Interactive car comparison tools, payment calculators, and ownership cost guides. Find the perfect vehicle for your budget.'
@endphp 
...
@section('og_title', 'Tools & Expert Advice | ' . app('globalSeo')['name'] ?? app('globalSeo')['og_title'])
...
@section('twitter_title', 'Tools & Expert Advice | ' . app('globalSeo')['name'] ?? app('globalSeo')['twitter_title'])
...
@section('title', 'Tools & Expert Advice | ' . app('globalSeo')['name'])
                    ...
                    @if($news->isNotEmpty())
                        <div class="row">
                            @foreach ($news as $key => $data)
                                ...
                                :route="route('frontend.research.review.autonews.details', ['categorySlug' => 'tools-&-advice','slug' => $data->slug])"
                                :main="route('frontend.research.tools.advice')"
                                />
                            @endforeach
