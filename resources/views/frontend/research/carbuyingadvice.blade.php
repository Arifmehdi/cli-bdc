...
@php 
$description = 'Expert car buying tips, negotiation strategies, and dealership insights. Learn how to get the best deal on your next vehicle.';
@endphp
...
@section('og_title', 'Car Buying Advice | ' . app('globalSeo')['name'] ?? app('globalSeo')['og_title'])
...
@section('twitter_title', 'Car Buying Advice | ' . app('globalSeo')['name'] ?? app('globalSeo')['twitter_title'])
...
@section('title', 'Car Buying Advice | ' . app('globalSeo')['name'])
                    ...
                    @if($news->isNotEmpty())
                        <div class="row">
                            @foreach ($news as $key => $data)
                                ...
                                type="Car Buying Advice"
                                {{-- :route="route('article.details', ['slug' => $data->slug])" --}}
                                :route="route('frontend.research.review.autonews.details', ['categorySlug' => 'car-buying-advice','slug' => $data->slug])"
                                :main="route('frontend.research.car.buying.advice')"
                                />
                            @endforeach
