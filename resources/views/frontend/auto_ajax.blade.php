                        ...
                        <div style="padding:18px; border-radius:4px;" class="bg-white auto-page-filter-topbar">
                            ...
                            <div class="d-flex justify-content-between top-fil align-items-center w-100 mt-1"
                                ...
                                <h6 class="mb-0  text-center show-text  p-1 highlight-count d-flex align-items-center justify-content-center"
                                    ...
                                    Showing  {{ $single_inventories_count }} of {{ $total_count }} results
                                </h6>
            ...
            @forelse ($inventories as $index => $inventory)
                ...
                <div class="col-lg-4 col-md-6 col-xl-4 col-sm-6 col-xs-12 main-element-card">
                    <div class="card">
                        <div class="item-card9-img">
                            ...
                            @php
                                $image_obj =
                                    $inventory->local_img_url ?? $inventory->additionalInventory['local_img_url']; // Get the image URLs as a string
                                ...
                                $route_string = str_replace(
                                    ...
                                    $inventory->year .
                                        ...
                                        $inventory->model .
                                        '-in-' .
                                        ($inventory->city ?? ($inventory->dealer['city'] ?? $inventory->dealer->city)) .
                                        '-' .
                                        strtoupper(
                                            $inventory->state ??
                                                ($inventory->dealer['state'] ?? $inventory->dealer->state),
                                        ),
                                );
                            @endphp
                                ...
                                <a
                                    ...
                                    <div class="item-card9">
                                            ...
                                            @if ($inventory->price_rating != null)
                                                ...
                                                @elseif($inventory->price_rating == 'fair-deal')
                                                    <div style="display: inline-flex; align-items: center; gap: 8px;">
                                                        ...
                                                        <p style="line-height:1; font-size:14px; margin: 0;">Fair Price
                                                        </p>
                                                    </div>
                                                @endif
                                            @endif
                                        ...
                                        <p class="mt-1 mb-1" style="font-size:14px; border-top:1px solid #E4E4E5">
                                            <strong>{{ $inventoryName = $inventory->name ?? (($inventory->name ? explode(' in ', $inventory->name)[0] : null) ?? $inventory->dealer['name']) }}</strong>
                                        </p>
                            ...
                            <div class="mb-2">
                                <span>{{ $averageRating }} {!! renderStars($averageRating) !!} {{ $reviews }}</span>
                                        ...
                                        @php
                                            ...
                                            $dealer_full_address =
                                                $inventory->city ?? $inventory->dealer['dealer_full_address'];
                                        @endphp
                ...
                @if ($index == 6)
                    ...
                    <div style="margin:0 auto" class="col-lg-4 col-md-6 col-xl-4 col-sm-6 col-xs-12">
                        @php
                            $banners = \App\Models\Banner::where('position', 'auto page middle')
                                ->where('status', 1)
                                ->first();
                        @endphp
