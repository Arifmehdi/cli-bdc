...
<style>
    /* Wrapper Styling (Transparent Background) */
.item-search-tabs {
    background: transparent; /* Transparent background */
    border-radius: 8px;
    padding: 15px;
    /* box-shadow: 0 4px 6px #7D8388; */
}
...
.item-search-menu ul li a {
    ...
    font-weight: 500;
    color: black;
    background: rgba(229, 229, 229, 0.5); /* More transparent background */
    transition: all 0.3s ease;
}

/* Active/Clicked Tab */
.item-search-menu ul li a.active {
    color: #7D8388;
}
                    ...
                    <div class="mx-auto col-xl-10 col-lg-12 col-md-12 d-block">
                        <div class="item-search-tabs">
                            <div class="item-search-menu">
                                <ul class="nav">
                                    <li class=""><a href="#tab1" class="active" data-bs-toggle="tab" style="color:white">Make/Model</a>
                                    </li>
...
<section style="padding-top: 5px !important; padding-bottom:3px !important" class="sptb2">
    <div style="border-radius:5px" class="container bg-white p-5">
        ...
        <div style="margin: 0 auto" class="row mb-4">
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card">
                {{-- <a href="{{ route('auto', ['zip' => '78702', 'radius' => '75','home2'=>true]) }}" --}}
                <a href="{{ route('auto', ['zip' => '77418', 'radius' => '75','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Austin, TX</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card">
                {{-- <a href="{{ route('auto', ['zip' => '02113','radius' => '75','home2'=>true]) }}" --}}
                <a href="{{ route('auto', ['zip' => '02110','radius' => '75','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Boston, MA</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card">
                {{--<a href="{{ route('auto', ['zip' => '28212','radius' => '75','home2'=>true]) }}" --}}
                <a href="{{ route('auto', ['zip' => '33954','radius' => '75','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Charlotte, NC</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card">
                <a href="{{ route('auto', ['zip' => '60630','radius' => '75','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Chicago, IL</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card">
                <a href="{{ route('auto', ['zip' => '43204','radius' => '75','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Columbus, OH</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card">
                <a href="{{ route('auto', ['zip' => '75241','radius' => '75','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Dallas, TX</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card">
                <a href="{{ route('auto', ['zip' => '80273','radius' => '75','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Denver, CO</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card">
                <a href="{{ route('auto', ['zip' => '48288','radius' => '75','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Detroit, MI</a>
            </div>
            <!-- sw fuweoifoiwe uoiwey  we8iryuweiru oiwerui weruoiweuroi uweroiuwoiruweoiruwi i  -->
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card">
                <a href="{{ route('auto', ['zip' => '79914','radius' => '75','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars El Paso, TX</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card">
                <a href="{{ route('auto', ['zip' => '76130','radius' => '75','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Fort Worth, TX</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card">
                <a href="{{ route('auto', ['zip' => '77007','radius' => '75','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars in Houston, TX</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card">
                <a href="{{ route('auto', ['zip' => '46256','radius' => '75','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Indianapolis, IN</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card">
                <a href="{{ route('auto', ['zip' => '32201','radius' => '75','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Jacksonville, FL</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card">
                <a href="{{ route('auto', ['zip' => '90019','radius' => '75','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Los Angeles, CA</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card">
                <a href="{{ route('auto', ['zip' => '38118','radius' => '75','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Memphis, TN</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card">
                <a href="{{ route('auto', ['zip' => '37216','radius' => '75','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Nashville, TN</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card">
                <a href="{{ route('auto', ['zip' => '10150','radius' => '75','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars New York, NY</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card">
                <a href="{{ route('auto', ['zip' => '19175','radius' => '75','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Philadelphia, PA</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card">
                <a href="{{ route('auto', ['zip' => '85020','radius' => '75','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Phoenix, AZ</a>
            </div>

            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card">
                <a href="{{ route('auto', ['zip' => '78205','radius' => '75','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars in San Antonio, TX</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card">
                <a href="{{ route('auto', ['zip' => '92104','radius' => '75','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars San Diego, CA</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card">
                <a href="{{ route('auto', ['zip' => '94164','radius' => '75','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars San Francisco, CA</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card">
                <a href="{{ route('auto', ['zip' => '95119','radius' => '75','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars San Jose, CA</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card">
                <a href="{{ route('auto', ['zip' => '98127','radius' => '75','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Seattle, WA</a>
            </div>

            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card">
                <a href="{{ route('auto', ['zip' => '20538','radius' => '75','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Washington, DC</a>
            </div>
        </div>
    </div>
</section>
...
<!--Recent News Section Statrt Here -->
@if($news->count() > 1)
...
<!--Recent Tips Section Statrt Here -->
@if($blogs->count() > 1)
<section style="padding-top: 5px !important; padding-bottom:5px !important" class="sptb">
    <div style="border-radius:5px; padding-bottom:25px" class="container bg-white p-5">
        <div class="text-center section-title center-block">
            <h2 style="margin-top:15px">Recent Research</h2>
            <p style="margin-bottom:10px; font-size:17px; color:rgb(32, 32, 32)">Start your search by choosing one of the most popular reviews. </p>
        </div>
        <div style="width:90% !important; margin: 0 auto !important; " id="defaultCarousel1"
            class="owl-carousel Card-owlcarousel owl-carousel-icons mb-5">
            ...
            <div class="item">
                <div class="mb-0 card">
                    <div class="item7-card-img">
                        <a href="{{ route('article.details', ['slug' => $new->slug]) }}"></a>
                        @if (isset($new->img))

                        <img style="width: 100%; height:260px" class="news-img"
                            src="{{ asset('frontend') }}/assets/images/blog/{{ $new->img }}"
                            alt="Used cars for sale Best Dream car {{ $new->title }} review image"
                            onerror="this.onerror=null; this.src='{{ asset('frontend/NotFound.png') }}';" />
                        @else
                        <img style="width: 100%; height:260px" class="news-img"
                            src="{{ asset('frontend/found/NotFound.png') }}" alt="img" />
                    ...
                    <div class="card-body p-4">
                        ...
                        $title = Str::limit($new->title, 21, '...');
                        @endphp
                        <a href="{{ route('article.details', ['slug' => $new->slug]) }}" class="text-dark">
                            <h5 style="font-weight:600" class="fs-20 news-tit hyperlink-title">{{ $title }}</h5>
                        </a>

                        @php
                        $sub_title = Str::limit(strip_tags($new->description), 100, '...');
                        @endphp
                        <p style="height:80px" class="news-par">{{ $sub_title }}</p>
                        <a href="{{ route('frontend.tips.details', ['slug' => $new->slug]) }}"
                            style="float:right; color:darkcyan">Read more <i class="fa fa-angle-right ms-1"></i></a>
