                            ...
                            <div class="item-card9">
                                <style>
                                    .title-wrapper {
                                            ...
                                            word-break: break-word; /* Ensures proper line breaking for long words */
                                            white-space: normal;    /* Allows wrapping to the next line */
                                            width: 100%;            /* Adjust the width as needed */
                                        }
                                </style>
                                        <p style="margin-top:10px; line-height:1; font-size:12px">{{ ucfirst($inventory->type) }}</p>
                                        <p class="title-wrapper">{{ $inventory->title }}</p>
                                        <p style="line-height:1; font-size:14px">{{ (number_format($inventory->miles)) ? number_format($inventory->miles). ' miles': ' TBD' }}</p>
                                        <h4 style="line-height:1.1; font-size:20px ;font-weight:700">{{ $inventory->PriceFormate }}
                                        <!-- price drop adde start -->
                                        @php
