...
<section style="margin-top:0; margin-bottom:45px;" class="deatails-card">
                                ...
                                <div class="swiper-slide">
                                    <a href="javascript:void(0);" data-bs-toggle="modal"
                                        ...
                                        <img style="width:674px !important; margin:0 !important; height:500px"
                                            src="{{ ($count > 1) ? asset($image) : asset('frontend/NotFound.png') }}"
                        ...
                        <div style="width:97%; margin:0 auto" class="row mt-2 mb-3">
                            <div thumbsSlider="" class="swiper mySwiper">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        @if ($image_obj != '' && $image_obj != '[]')
                                        <img class="me-2 br-3 swipper-bottom-image" src="{{ ($count > 1) ? asset($image) : asset('frontend/NotFound.png') }}"
                                ...
                                <section>
                                    ...
                                    @php
                                    // Parse the car price
                                    $price_cus_amount = (int) str_replace(['$', ','], '', $inventory->price_formate); // Car price: 11995
                                    ...
                                    $global_cus_monthly_payment = ($total_loan_amount * $monthly_interest_rate * pow(1 + $monthly_interest_rate, $loan_term_months)) /
                                    ...
                                    @endphp
                                    <p style="margin-top:25px; line-height:1; font-size:12px">{{ ucfirst($inventory->type) }}</p>
                                    <style>
   
                                    </style>
                                    <p class="inventory-title " >{{ $inventory->title }}</p>
                                    <p style="line-height:1; font-size:14px">{{ number_format($inventory->miles) . ' miles' }}</p>
                                    <h4 style="line-height:1.1; font-size:20px ;font-weight:700">{{ $inventory->PriceFormate }}
                                    ...
                                    <p style="display: inline-block;border-bottom:1px solid black;line-height:1; font-size:14px">EST. ${{ floor($global_cus_monthly_payment) }}/mo*</p>
                                    <br>
            ...
            <div class="border-0">
                ...
                <div class="tab-content border br-ts-0 br-3 p-5 bg-white mb-4 over-view-card">
                    <div class="tab-pane active" id="tab-1">
                                ...
                                <div class="row p-2">
                                    ...
                                    <div style="margin-left:-12px !important"
                                        ...
                                        <div style="display: flex; margin-bottom:6px" class="boxicons"
                                            ...
                                            <img style="width:40px; height:40px; border:0.5px solid gray; border-radius:50%; padding:6px"
                                                src="{{ asset('/frontend/assets/images/art.png') }}" alt="Used cars for sale for Best Dream car exteriror color image icon"/>
                                        ...
                                        <div style="display: flex; margin-bottom:6px" class="boxicons"
                                            title="Fuel ">
                                            <img style="width:40px; height:40px; border:0.5px solid gray; border-radius:50%; padding:6px"
                                                src="{{ asset('/frontend/assets/images/gas.png') }}" alt="Used cars for sale for Best Dream car fuel image icon" />
                                            <p style="color:black; margin-left:10px; font-weight:600; margin-top:11px"
                                                class="auto-icon-para">MPG :
                                                {{ str_replace('----',' ',$inventory->mpg_city) }} City/ {{ str_replace('----',' ',$inventory->mpg_highway) }} Highway
                                            </p>
                                        </div>
                                        <div style="display: flex; margin-bottom:6px " class="boxicons"
                                            title="Drive Train ">
                                            <img style="width:40px; height:40px; border:0.5px solid gray; border-radius:50%; padding:6px"
                                                src="{{ asset('/frontend/assets/images/drive.png') }}" alt="Used cars for sale for Best Dream car drivetrain image icon"/>
                                            <p style="color:black; margin-left:10px; font-weight:600; margin-top:11px"
                                        ...
                                        <div style="display: flex; margin-bottom:6px" class="boxicons"
                                            title="VIN">
                                            <img style="width:40px; height:40px; border:0.5px solid gray; border-radius:50%; padding:6px"
                                                src="{{ asset('/frontend/assets/images/calendar.png') }}" alt="Used cars for sale for Best Dream car vin image icon"/>
                                            <p style="color:black; margin-left:10px; font-weight:600; margin-top:11px"
                                        ...
                                        <div style="display: flex; margin-bottom:6px" class="boxicons"
                                            title="Vehicle Type">
                                            <img style="width:40px; height:40px; border:0.5px solid gray; border-radius:50%; padding:6px"
                                                src="{{ asset('/frontend/assets/images/used.png') }}"  alt="Used cars for sale for Best Dream car vehicle type image icon"/>
                                            <p style="color:black; margin-left:10px; font-weight:600; margin-top:11px"
                                        ...
                                        <div style="display: flex; margin-bottom:6px" class="boxicons"
                                            title="Year">
                                            <img style="width:40px; height:40px; border:0.5px solid gray; border-radius:50%; padding:6px"
                                                src="{{ asset('/frontend/assets/images/calendar.png') }}" alt="Used cars for sale for Best Dream car calendar image icon"/>
                                            <p style="color:black; margin-left:10px; font-weight:600; margin-top:11px"
                                        ...
                                        <div style="display: flex; margin-bottom:6px" class="boxicons"
                                            title="Location">
                                            <img style="width:40px; height:40px; border:0.5px solid gray; border-radius:50%; padding:6px"
                                                src="{{ asset('/frontend/assets/images/location.png') }}" alt="Used cars for sale for Best Dream car location image icon"/>
                                            <p style="color:black; margin-left:10px; font-weight:600; margin-top:11px"
                                                class="auto-icon-para">Location
                                                : {{ $inventory->dealer->city }}, {{ $inventory->dealer->state }}
                                            </p>
                                        </div>
                                    </div>
                                    <div style="margin-left:-12px" class="col-xs-12 col-md-6  col-sm-6 ">
                                        <div style="display: flex; margin-bottom:6px" class="boxicons"
                                            ...
                                            <img style="width:40px; height:40px; border:0.5px solid gray; border-radius:50%; padding:6px"
                                                src="{{ asset('/frontend/assets/images/model.png') }}" alt="Used cars for sale for Best Dream car interior color image icon"/>
                                            <p style="color:black; margin-left:10px; font-weight:600; margin-top:11px"
                                                class="auto-icon-para">Interior : {{ $inventory->interior_color }}</p>
                                        </div>
                                        <div style="display: flex; margin-bottom:6px" class="boxicons "
                                            title="Fuel">
                                            <img style="width:40px; height:40px; border:0.5px solid gray; border-radius:50%; padding:6px"
                                                src="{{ asset('/frontend/assets/images/g.png') }}" alt="Used cars for sale for Best Dream car fuel image icon" />
                                            <p style="color:black; margin-left:10px; font-weight:600; margin-top:11px"
                                                class="auto-icon-para">Fuel Type : {{ str_replace('----',' ',$inventory->fuel) }}
                                            </p>
                                        </div>
                                        <div style="display: flex; margin-bottom:6px" class="boxicons"
                                            title="Transmission">
                                            ...
                                            <img style="width:40px; height:40px; border:0.5px solid gray; border-radius:50%; padding:6px"
                                                src="{{ asset('/frontend/assets/images/transmission.png') }}" alt=" Used cars for sale for Best Dream car transmission image icon"/>
                                            <p style="color:black; margin-left:10px; font-weight:600; margin-top:11px"
                                        ...
                                        <div style="display: flex; margin-bottom:6px" class="boxicons"
                                            title="Engine">
                                            <img style="width:40px; height:40px; border:0.5px solid gray; border-radius:50%; padding:6px"
                                                src="{{ asset('/frontend/assets/images/engine.png') }}" alt="Used cars for sale for Best Dream car engine image icon"/>
                                            <p style="color:black; margin-left:10px; font-weight:600; margin-top:11px"
                                        ...
                                        <div style="display: flex; margin-bottom:6px" class="boxicons"
                                            title="Listed">
                                            <img style="width:40px; height:40px; border:0.5px solid gray; border-radius:50%; padding:6px"
                                                src="{{ asset('/frontend/assets/images/add.png') }}" alt="Used cars for sale for Best Dream car listed day image icon"/>
                                            <p style="color:black; margin-left:10px; font-weight:600; margin-top:11px"
                                                class="auto-icon-para">Added : {{ $inventory->created_at ? $inventory->created_at->diffInDays(now()) . ' days ago' : ' ' }} </p>

                                        </div>
                                        <div style="display: flex; margin-bottom:6px" class="boxicons"
                                            title="Model">
                                            <img style="width:40px; height:40px; border:0.5px solid gray; border-radius:50%; padding:6px"
                                                src="{{ asset('/frontend/assets/images/model.png') }}" alt="Used cars for sale for Best Dream car model image icon"/>
                                            <p style="color:black; margin-left:10px; font-weight:600; margin-top:11px"
                                        ...
                                        <div style="display: flex; margin-bottom:6px" class="boxicons"
                                            title="Body Type">
                                            <img style="width:40px; height:40px; border:0.5px solid gray; border-radius:50%; padding:6px"
                                                src="{{ asset('/frontend/assets/images/b.png') }}" alt="Used cars for sale for Best Dream car vehicle body type image icon"/>
                                            <p style="color:black; margin-left:10px; font-weight:600; margin-top:11px"
                                                class="auto-icon-para">Body : {{ ucwords($inventory->body_formated) }}
                                            </p>
                                        </div>
                        ...
                        $features[trim($category)] = array_map('trim', explode(';', $featuresList));
                        }
                        }
                        @endphp
                    ...
                    @endif
                        ...
                        <p class="mb-5" style="max-height: 60px; overflow: hidden; text-overflow: ellipsis;">
                            {{ $inventory->additionalInventory->vehicle_feature_description }}
                        </p>
                        <a id="viewMoreAdditionalButton" class="p-0" data-bs-toggle="modal" data-bs-target="#featuresModal">
                            <strong class="hyperlink-title" style="border-bottom: 1px solid black;">View all features</strong> <i class="fa fa-caret-down"></i>
                        </a>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body" style="max-height: 400px; overflow-y: auto;">
                                        ...
                                        $features = explode(',', $inventory->additionalInventory->vehicle_feature_description);
                                        @endphp
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <ul style="list-style-type: disc; padding-left: 20px;">
                                                    ...
                                                    @if ($index % 2 == 0) <!-- Features for first column -->
                                                    <li style="color: aqua; font-size:16px"> <span style="color:black; font-size:16px">{{ trim($feature) }}</span></li>
                                                    @endif
                                                    @endforeach
                                                </ul>
                                            </div>
                                            <div class="col-md-6">
                                                <ul style="list-style-type: disc; padding-left: 20px;">
                                                    @foreach ($features as $index => $feature)
                                                    @if ($index % 2 != 0) <!-- Features for second column -->
                                                    <li style="color: aqua; font-size:16px"> <span style="color:black; font-size:16px">{{ trim($feature) }}</span></li>
                                                    @endif
                                                    @endforeach
                                                </ul>
            ...
            <div class="row">
                <div class="col-md-12 p-2">
                    ...
                    <div class="row">
                        ...
                        <div class="mt-5">
                            <h4 style="font-size:20px"><strong>Seller’s notes about this car</strong></h4>
                            <!-- Seller's Notes Section -->
                            <p id="sellerNotes" class="mb-5" style="max-height: 60px; overflow: hidden; text-overflow: ellipsis;">
    ...
    <div class="hide-on-phone hide-on-tablet">
        ...
        <div id="myCarousel5" class="owl-carousel owl-carousel-icons3">
            ...
            <div class="empty-card">
                <div style="background: #f5f5f5; padding: 20px; text-align: center;" class="card mb-0">
                    <h4 style="color: #999;">No related items found</h4>
                    <p style="color: #666;">Please check back later or explore other categories.</p>
                </div>
            </div>
            @endforelse
        </div>
    ...
    <div class="col-xl-5 col-lg-5 col-md-12">
        <!-- message seller card  -->
        <div class="hide-on-laptop hide-on-phone card shadow-sm mx-auto " style="max-width: 31rem; position: relative;">
            <!-- Love and Share Icons -->
            <div class="position-absolute" style="top: 10px; right: 10px; z-index: 10;">
                <!-- Love Icon -->
                <a href="javascript:void(0)" class="me-3" id="wishlist2" style="font-size:1.5rem;" title="Favorites">
                    @if ($countWishList > 0)
                    <i class="fa fa-heart" style="color: red"></i>
                    @else
                    <i class="fa fa-heart-o"></i>
            ...
            <div class="card-body">
                ...
                <h5 class="card-title mt-2">
                    ...
                    @php
                    $make_title = $inventory->make . ' ' . $inventory->model . ' ' . ucwords(str_replace('_', ' ', $inventory->trim == 'N/A' ? '' : $inventory->trim));
                    @endphp
                ...
                <!-- Price -->
                <h3 class="fw-bold text-dark" style="font-size:2.5rem">{{ $inventory->price_formate }} <strong style="font-weight:300px; font-size:12px" id="strong_monthly_pay">${{$inventory->payment_price}} /mo*</strong></h3>
                ...
                <div class="bg-light p-3 rounded mt-4">
                    ...
                    <div class="form-check mt-2">
                        ...
                        <label class="form-check-label" for="tailoredOffer">
                            Receive a tailored offer instantly, complete with realistic monthly payments for this vehicle.
                        </label>
                    </div>
                    <!-- Button -->
                    <button class="front-btn btn btn-block mt-3" target="#submitBtn" onclick="document.getElementById('message-seller').scrollIntoView({ behavior: 'smooth' });">Message Seller</button>
                </div>
            </div>
        </div>
                    ...
                    <div style="border-radius:6px; box-shadow: rgba(100, 100, 111, 0.2) 0px 4px 7px 0px;"
                        ...
                        <form id="SendLeaddetails" style=" border-radius:5px">
                            ...
                            <div class="">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 ">
                                        <div class="form-group ">
                                            <p style="color: rgb(77, 74, 74)"><input type="checkbox"
                                                    ...
                                                    style="cursor: pointer" checked> Email me price drops for this vehicle </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 ">
                                    <div class="form-group">
                                        <button type="submit" class="front-btn btn loading" id="submitBtn">Send Message</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                ...
                <div style="border-radius:6px; box-shadow: rgba(100, 100, 111, 0.2) 0px 4px 7px 0px;"
                    ...
                    <div style="background: white; height:auto;" class="widget">
                        <div class="financial-detail-card">
                            ...
                            <h2 style="display:block; text-align:center; color:white; font-weight:500">
                                $<span class="ms-1" id="calculator_monthly_pay">{{ $inventory->payment_price ?? number_format($$global_cus_monthly_payment) }}</span>
                            </h2>
                            <p class="p-0 m-0"
                                style="font-size:16px; display:block; text-align:center; color:rgb(235, 231, 231)"
                                id="calculator_loan_amount"><small>Total Loan Amount : {{$loan_amount}}</small></p>
                            <p
                                style="font-size:15px; display:block; text-align:center; color:rgb(235, 231, 231)">
                                ...
                                <ul>
                                    ...
                                    <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                        <div class="row">
                                            <div class=" col-lg-6 col-sm-6 col-md-6">
                                                ...
                                                <div style="width:100%" class="input-container">
                                                    <span class="dollar-sign">$</span>
                                                    <input type="text" class="form-control common_calculator"
                                                        placeholder="Enter a down payment"
                                    ...
                                    <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                        <div class="row">
                                            ...
                                            <div class=" col-lg-6 col-sm-6 col-md-6">
                                                <label style="margin-top:15px">Sales Tax <span id="sales_tax_rate_level">{{ $cityrate ?? $stateRate}}</span>%</label>
                                                <input type="hidden" name="sales_tax_rate" id="sales_tax_rate" value="{{ $cityrate ?? $stateRate}}">
                                                <input type="text"
                                                    class="form-control common_calculator mb-2"
                                                    placeholder="Sales Tax 8%"
                                                    id="sales_tax">
                                            </div>
                                        </div>
                                    </li>
                                        ...
                                        <div class="d-flex flex-wrap mt-3 ms-2">
                                            <div class="p-2 monthly-package">
                                                <li>
                                                    <input
                                                        style="width:69px; height:45px; text-align:center; border-radius:5px; border:1px solid gray; cursor:pointer"
                                                        type="text" value="24" class="calculate_month"
                                                        id="24" readonly />
                                                </li>
                                            </div>
                                            <div class="p-2 monthly-package">
    ...
    <div class="card">
        <div class="card-body item-user">
            ...
            @php
                        $firstListedDate = $inventory->mainPriceHistory->isEmpty() ? $inventory->created_at : $inventory->mainPriceHistory->first()->change_date;
                        $listedDaysAgo = \Carbon\Carbon::parse($firstListedDate)->diffInDays(\Carbon\Carbon::now());
                        @endphp

                        <p class="mt-3 mb-0">Listed <strong>{{ $listedDaysAgo }}</strong> days ago</p>
                        @php
            ...
            <p class="mt-0"><strong>
                ...
                @endforeach
                @if($totalPriceChange < 0)
                    ${{ number_format(abs($totalPriceChange), 2) }} total price reduction
                @elseif($totalPriceChange > 0)
                    ${{ number_format($totalPriceChange, 2) }} total price increase
                @else
                    No price change
                @endif
            </strong></p>
            ...
            <div class="row p-0">
                <table class="table">
                    @foreach($inventory->mainPriceHistory as $history)
                    @if($loop->last) <!-- Check if this is the last iteration -->
                    <tr>
                        <th>{{ \Carbon\Carbon::parse($history->change_date)->format('m/d/Y') }}</th>
                        <th>{{ $history->change_amount }}</th>
                        <th>${{ number_format($history->amount, 2) }}</th>
                    </tr>
                    @else
                    <tr>
                        <td>{{ \Carbon\Carbon::parse($history->change_date)->format('m/d/Y') }}</td>
                ...
                <p class="text-muted" style="font-size:12px"><small>Total price amount is based on price change information provided by the seller</small></p>
            </div>
        </div>
    </div>
    @endif
                        ...
                        <div class="item-card2">
                            <div class="item-card2-desc">
                                ...
                                <div style="height: 25px" class="d-flex mb-1">
                                    ...
                                    @php
                                    // Parse the car price
                                    $price_cus_amount = (int) str_replace(['$', ','], '', $item->price_formate); // Car price: 11995
                                    ...
                                    // Calculate monthly payment using amortization formula
                                    $cus_monthly_payment = ($total_loan_amount * $monthly_interest_rate * pow(1 + $monthly_interest_rate, $loan_term_months)) /
                                    (pow(1 + $monthly_interest_rate, $loan_term_months) - 1);
    ...
    @if($other_vehicles->count() > 1)
    <div class="container py-5 hide-on-phone">
        <h4>Other Vehicles From This Seller</h4>
        <div id="cardSlider" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <div class="row">
                        <!-- Card 1 -->
                        @forelse ($other_vehicles as $index => $carData)
                        ...
                        <div class="col-md-3">
                            <div class="card position-relative shadow-sm">
                                ...
                                <a href="{{ route('auto.details', ['vin' => $vin_string_replace, 'param' => $route_string]) }}">
                                    <img src="{{ asset( $image) }}" class="card-img-top" alt="Car Image" loading="lazy"  onerror="this.onerror=null; this.src='{{ asset('frontend/NotFound.png') }}';">
                                </a>
                                <div class="card-body">
                                    <small>
                                    ...
                                    <p class="mileage">{{ number_format($carData->miles) . ' miles' }}</p>
                                    <p class="location">{{$carDataCity }}, {{$carDataState}}</p>
                                </div>
                            </div>
                        </div>
                        @empty
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="card position-relative shadow-sm">
                ...
                <img src="https://via.placeholder.com/300x180/eee" class="card-img-top" alt="Car Image">
                <div class="card-body">
                  <h6 class="card-title">Used 2017 Toyota Mirai Sedan</h6>
                  <p class="price">$6,995</p>
                  <p class="mileage">50k mi</p>
                  <p class="location">Santa Monica, CA</p>
                </div>
              </div>
            </div>
            <!-- Card 6 -->
            <div class="col-md-3">
              <div class="card position-relative shadow-sm">
                ...
                <img src="https://via.placeholder.com/300x180/bbb" class="card-img-top" alt="Car Image">
                <div class="card-body">
                  <h6 class="card-title">Used 2016 Toyota Mirai Sedan</h6>
                  <p class="price">$5,500</p>
                  <p class="mileage">72k mi</p>
                  <p class="location">Santa Monica, CA</p>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-3">
              <div class="card position-relative shadow-sm">
                ...
                <img src="https://via.placeholder.com/300x180/444" class="card-img-top" alt="Car Image">
                <div class="card-body">
                  <h6 class="card-title">Used 2015 Toyota Mirai Sedan</h6>
                  <p class="price">$4,995</p>
                  <p class="mileage">80k mi</p>
                  <p class="location">Santa Monica, CA</p>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-3">
              <div class="card position-relative shadow-sm">
                ...
                <img src="https://via.placeholder.com/300x180/111" class="card-img-top" alt="Car Image">
                <div class="card-body">
                  <h6 class="card-title">Used 2014 Toyota Mirai Sedan</h6>
                  <p class="price">$3,995</p>
                  <p class="mileage">90k mi</p>
                  <p class="location">Santa Monica, CA</p>
                </div>
              </div>
            </div>
            ...
            <div style="position:relative; padding:0 !important; margin:0 !important;" class="modal-body">
                <div style="--swiper-navigation-color: #ffffff; --swiper-pagination-color: #fff"
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            @if ($image_obj != '' && $image_obj != '[]')
                            <img style="width:100% !important; margin:0 !important; height:600px" class="br-3" src="{{ asset($image) }}"
                                alt="Used cars for sale {{ $inventory->title }}, price is {{ $inventory->price }}, vin {{ $inventory->vin }} in {{ $inventory->dealer->city }},{{ strtoupper($inventory->dealer->state) }}, dealer name is {{ $inventory->dealer->name }} Best Dream car image "
                                loading="lazy"
                                onerror="this.onerror=null; this.src='{{ asset('frontend/NotFound.png') }}';">
                            @elseif ($image_obj == '[]')
...
<script>
    ...
    document.getElementById('viewMoreButton').addEventListener('click', function() {
        ...
        if (isCollapsed) {
            ...
            this.innerHTML = '<strong class="hyperlink-title" style="border-bottom:1px solid black">View less seller\'s note</strong> <i class="fa fa-caret-up"></i>';
        } else {
            // Collapse the content
            sellerNotes.style.maxHeight = '60px';
            sellerNotes.style.overflow = 'hidden';
            this.innerHTML = '<strong class="hyperlink-title" style="border-bottom:1px solid black">View all seller\'s note</strong> <i class="fa fa-caret-down"></i>';
        }
    });
</script>
