    ...
    <div style="border-radius:5px" class="container bg-white p-5">
        ...
        <div style="margin: 0 auto" class="row mb-4">
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card mb-4">
                <a href="{{ route('auto', ['zip' => '78702', 'radius' => '25','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Austin, TX</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card mb-4">
                <a href="{{ route('auto', ['zip' => '02113','radius' => '25','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Boston, MA</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card mb-4">
                <a href="{{ route('auto', ['zip' => '28212','radius' => '25','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Charlotte, NC</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card mb-4">
                <a href="{{ route('auto', ['zip' => '60630','radius' => '25','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Chicago, IL</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card mb-4">
                <a href="{{ route('auto', ['zip' => '43204','radius' => '25','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Columbus, OH</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card mb-4">
                <a href="{{ route('auto', ['zip' => '75241','radius' => '25','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Dallas, TX</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card mb-4">
                <a href="{{ route('auto', ['zip' => '80273','radius' => '25','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Denver, CO</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card mb-4">
                <a href="{{ route('auto', ['zip' => '48288','radius' => '25','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Detroit, MI</a>
            </div>
            <!-- sw fuweoifoiwe uoiwey  we8iryuweiru oiwerui weruoiweuroi uweroiuwoiruweoiruwi i  -->
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card mb-4">
                <a href="{{ route('auto', ['zip' => '79914','radius' => '25','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars El Paso, TX</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card mb-4">
                <a href="{{ route('auto', ['zip' => '76130','radius' => '25','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Fort Worth, TX</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card mb-4">
                <a href="{{ route('auto', ['zip' => '77007','radius' => '25','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars in Houston, TX</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card mb-4">
                <a href="{{ route('auto', ['zip' => '46256','radius' => '25','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Indianapolis, IN</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card mb-4">
                <a href="{{ route('auto', ['zip' => '32201','radius' => '25','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Jacksonville, FL</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card mb-4">
                <a href="{{ route('auto', ['zip' => '90019','radius' => '25','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Los Angeles, CA</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card mb-4">
                <a href="{{ route('auto', ['zip' => '38118','radius' => '25','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Memphis, TN</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card mb-4">
                <a href="{{ route('auto', ['zip' => '37216','radius' => '25','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Nashville, TN</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card mb-4">
                <a href="{{ route('auto', ['zip' => '10150','radius' => '25','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars New York, NY</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card mb-4">
                <a href="{{ route('auto', ['zip' => '19175','radius' => '25','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Philadelphia, PA</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card mb-4">
                <a href="{{ route('auto', ['zip' => '85020','radius' => '25','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Phoenix, AZ</a>
            </div>

            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card mb-4">
                <a href="{{ route('auto', ['zip' => '78205','radius' => '25','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars in San Antonio, TX</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card mb-4">
                <a href="{{ route('auto', ['zip' => '92104','radius' => '25','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars San Diego, CA</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card mb-4">
                <a href="{{ route('auto', ['zip' => '94164','radius' => '25','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars San Francisco, CA</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card mb-4">
                <a href="{{ route('auto', ['zip' => '95119','radius' => '25','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars San Jose, CA</a>
            </div>
            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card mb-4">
                <a href="{{ route('auto', ['zip' => '98127','radius' => '25','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
                    class="city">Used Cars Seattle, WA</a>
            </div>

            <div class="col-md-4 col-lg-3 col-sm-6 col-xs-6 mb-4 make-card mb-4">
                <a href="{{ route('auto', ['zip' => '20538','radius' => '25','home2'=>true]) }}"
                    style="font-size: 16px; border-bottom:1px solid rgb(18, 176, 197); color:rgb(18, 176, 197) !important"
...
<section style="padding-top: 5px !important; padding-bottom:3px !important;margin-bottom:5px" class="sptb2 ">
    <div style="border-radius:5px" class="container bg-white p-5">
        ...
        <div style="margin: 0 auto" class="row make-list">
            ...
            @php
            $count_make_obj = \App\Models\MainInventory::where('make', $make_g->make_name)->where(
            'type',
            '!=',
            'new',
            );
            $count_make = $count_make_obj->count('make');
            // Get the count of prices greater than 0
            $count_greater_than_zero = $count_make_obj->where('price', '>', 0)->count();

            // Get the minimum price greater than 0
            $count_price = $count_make_obj->where('price', '>', 0)->min('price');

            // Format the number if it exists
            $formattedNumber = $count_price !== null ? number_format($count_price, 0, '.', ',') : '0';
