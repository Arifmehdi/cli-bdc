                    ...
                    <div class="">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item brd"><a style="color:black !important"
                                    ...
                                    for Sale </a></li>
                            <li class="breadcrumb-item brd"><a style="color:black !important"
                                    href="javascript:void(0);">{{ $inventory->make }} </a></li>
                            <li class="breadcrumb-item brd"><a style="color:black !important"
                                    href="javascript:void(0);">{{ $inventory->model }} </a></li>
                            <li class="breadcrumb-item brd"><a style="color:black !important"
                                    href="javascript:void(0);">{{ $inventory->vin }} </a></li>
                        </ol>
                    </div>
                </div>
            </div>
                                    ...
                                    <div thumbsSlider="" class="swiper mySwiper">
                                        ...
                                        <section>
                                            ...
                                            <p
                                                ...
                                                EST. ${{ floor($global_cus_monthly_payment) }}/mo*</p>
                                            <br>
                                                    ...
                                                    <div style="margin-left:-12px" class="col-xs-12 col-md-6  col-sm-6 ">
                                                        ...
                                                        <div style="display: flex; margin-bottom:6px" class="boxicons"
                                                            ...
                                                            <p style="color:black; margin-left:10px; font-weight:600; margin-top:11px"
                                                                ...
                                                                {{ $inventory->created_at ? $inventory->created_at->diffInDays(now()) . ' days ago' : ' ' }}
                                                            </p>
                            ...
                            <div id="myCarousel5" class="owl-carousel owl-carousel-icons3">
                                ...
                                background: linear-gradient(0deg, rgb(232, 245, 243) 0%, rgb(255, 255, 255) 100%);"
                                            ...
                                            <div class="item-card2-img">
                                                @if (count($images) > 1 && $image_obj != '' && $image_obj != '[]')
                                                    <a class="link"
                                                        href="{{ route('auto.details', ['vin' => $vin_string_replace, 'param' => $route_string]) }}"></a>
                                                    <img src="{{ asset($image) }}" alt="img" style=""
                                                        class="auto-ajax-photo-details" loading="lazy"
                                                        onerror="this.onerror=null; this.src='{{ asset('frontend/NotFound.png') }}';">
                                                @else
                                                    <img src="{{ asset('frontend/found/NotFound.png') }}" width="100%"
                                                        alt="img" style=""
                                                        class="auto-ajax-photo-details-not-found">
                                                @endif
                                            </div>
                    ...
                    <i class="fa fa-copy"></i>
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title mt-2">
                                ...
                                @php
                                    $make_title =
                                        ...
                                        ' ' .
                                        ucwords(
                                            str_replace('_', ' ', $inventory->trim == 'N/A' ? '' : $inventory->trim),
                                        );
                                @endphp
                            ...
                            <h3 class="fw-bold text-dark" style="font-size:2.5rem">{{ $inventory->price_formate }}
                                <strong
                                    style="font-weight:300px; font-size:12px">${{ floor($global_cus_monthly_payment) }}
                                    /mo* </strong></h3>
                                ...
                                <div style="border-radius:6px; box-shadow: rgba(100, 100, 111, 0.2) 0px 4px 7px 0px;"
                                    ...
                                    <div style="background: white; height:auto;" class="widget">
                                        <div class="financial-detail-card">
                                            ...
                                            <h2 style="display:block; text-align:center; color:white; font-weight:500">
                                                $<span class="ms-1"
                                                    id="calculator_monthly_pay">{{ $inventory->payment_price ?? number_format($$global_cus_monthly_payment) }}</span>
                                            </h2>
                                            <p class="p-0 m-0"
                                                style="font-size:16px; display:block; text-align:center; color:rgb(235, 231, 231)"
                    ...
                    @if (!$inventory->mainPriceHistory->isEmpty())
                        <div class="card">
                            <div class="card-body item-user">
                                ...
                                @php
                                    $firstListedDate = $inventory->mainPriceHistory->isEmpty()
                                        ? $inventory->created_at
                                        : $inventory->mainPriceHistory->first()->change_date;
                                    $listedDaysAgo = \Carbon\Carbon::parse($firstListedDate)->diffInDays(
                                        \Carbon\Carbon::now(),
                                    );
                                @endphp
