...
@section('title', 'Tips | ' . app('globalSeo')['name'])
        ...
        <div class="header-text mb-0">
            <div class="container">
                <div class="text-center text-white">
                    <h2 class="new-page-tilte">Tips</h2>
                    <ol class="breadcrumb text-center new-page-bred">
                        ...
                        <li class=""><a style="color:white" href="javascript:void(0);">Tips</a></li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div style="width:70%" class="col-xl-8 col-lg-8 col-md-7 col-sm-6 col-xs-12 new-first-option">
                @if($all->count() > 1)
                <h2 class="new-tit mb-4">Latest Tips</h2>
                @endif
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div>
                            <div class=" blog">
                                @if (isset($lastTips->img))
                                <a href="{{ route('frontend.tips.details', ['slug' => $lastTips->slug]) }}">
                                    <img height="500px" width="100%"
                                        src="{{ asset('/frontend/assets/images/tips/' . $lastTips->img) }}" alt="img"
                                        class="news-show-image-top" onerror="this.onerror=null; this.src='{{ asset('frontend/NotFound.png') }}';"/>
                                </a>
                                @elseif($lastTips && $lastTips->img == '')
                                <a href="{{ route('frontend.tips.details', ['slug' => $lastTips->slug]) }}">
                            ...
                            <div style="margin-bottom:30px">
                                ...
                                @php
                                $title = Str::limit($lastTips->title, 20, '...');

                                @endphp
                                @php
                                $des = Str::limit(strip_tags($lastTips->description), 100, '...');
                                @endphp
                                <a href="{{ route('frontend.tips.page') }}" class="text-dark">
                                    <p style="font-size:12px; color:rgb(4, 122, 126)" class="mt-3 mb-0">Tips & Advice</p>
                                </a>
                                <a href="{{ route('frontend.tips.details', ['slug' => $lastTips->slug]) }}"
                                    class="text-dark">
                                    <h5 style="font-size:25px; font-weight:600;"
                                        class=" mt-1 mb-0 hyperlink-title news-bold-title">{{ $lastTips->title }}</h5>
                                </a>

                                <p style="font-size:15px !important; width:95%" class="mt-1 mb-0">{{ $des }}</p>
                                <p style="font-size:13px" class="mt-1">
                                    {{\Carbon\Carbon::parse($lastTips->created_at)->format('F d, Y')}} </p>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 mb-4">
                        <div>
                            <div class="blog">
                                @if (isset($data->img))
                                <a href="{{ route('frontend.tips.details', ['slug' => $data->slug]) }}">
                                    <img height="270px" width="100%"
                                        src="{{ asset('/frontend/assets/images/tips/' . $data->img) }}" alt="img"
