...
@section('og_img', asset('/frontend/assets/images/tips/' . $data->img) ?? app('globalSeo')['og_img'])
...
@section('twitter_image', asset('/frontend/assets/images/tips/' . $data->img) ?? app('globalSeo')['og_img'])
            ...
            <div class="container">
                <div class="text-center text-white ">
                    ...
                    <ol class="breadcrumb text-center new-details-bred">
                        ...
                        <li>
                            <a style="color:white;" href="{{route('frontend.research.car.tips')}}">
                                Car Tips<span style="margin: 0 4px;">/</span>
                            </a>
                        </li>
                ...
                <div class="news-card">
                    <div class="">
                        ...
                        <div class="item7-card-img mt-2">
                            ...
                            @isset($data->img)
                            <img height="500px" src="{{ asset('/frontend/assets/images/tips/' . $data->img) }}" alt="img" class="w-100 br-5 mb-4 art-image" onerror="this.onerror=null; this.src='{{ asset('frontend/NotFound.png') }}';"/>
                            @else
                            ...
                            <div class="media m-0 mt-0 p-1">
                                ...
                                <div class="media-body">
                                    <h6 style="font-weight:600" class="mb-0 dea-tit">
                                        ...
                                        href="{{ route('frontend.tips.details', ['slug' => $new->slug]) }}">{{ $new->title }}</h4>
                                    </a>
                                    </h6>
