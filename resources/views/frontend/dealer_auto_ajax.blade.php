            ...
            <div class="col-lg-4 col-md-6 col-xl-4 col-sm-6 col-xs-12 main-element-card">
                <div class="card">
                    <div class="item-card9-img">
                        ...
                        @endphp
                        @php
                        $image_obj = $inventory->local_img_url ?? $inventory->additionalInventory['local_img_url']; // Get the image URLs as a string
                        ...
                        $inventory->model .
                        '-in-' .
                        $inventory->city  ?? $inventory->dealer['city'].
                        '-' .
                        ...
                        <div class="item-card9-imgs">
                            ...
                            @if (!empty($image) && $image != '[]')
                                <img width="100%"
                                    ...
                                    alt="Used cars for sale: {{ $inventory->title }}, price: {{ $inventory->price }}, VIN: {{ $inventory->vin }} in {{ $inventory->city }}, {{ $inventory->state }}, dealer name: {{ $inventory->name }}.'s Best Dream car image"
                                    class="auto-ajax-photo lazyload"
                                    loading="lazy"
                        ...
                        <div style="padding:12px !important " class="card-body ">
                            <a href="{{ route('auto.details', ['vin' => $vin_string_replace, 'param' => $route_string]) }}">
                                <div class="item-card9">
                                    ...
                                    <div class="flex-container">
                                        ...
                                        <h4 style="margin-bottom:0; font-size:20px ;font-weight:700">${{ number_format($inventory->price) }}</h4>
                                    </div>
                            ...
                            <div class="mb-2">
                                ...
                                @php
                                    ...
                                    $dealer_full_address = $inventory->city ?? $inventory->dealer['dealer_full_address'];
                                @endphp

                                <i style="color:black !important" class="fa fa-map-marker text-muted me-1"></i>
                                <span class=" ">{{ $city .', ' .strtoupper($state ) ?? $dealer_full_address  }}</span>
