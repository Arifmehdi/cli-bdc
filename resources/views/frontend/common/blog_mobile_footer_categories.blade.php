...
<style>
    .hashtags-plain {
        ...
        line-height: 1.5;
        word-wrap: break-word; /* Ensures responsiveness */
        margin-bottom: 2rem;
    }
    
    .hashtags-plain a {
        color: #0066cc; /* Simple blue link color */
        text-decoration: none;
        margin-right: 8px; /* Small space between tags */
        white-space: nowrap; /* Keeps individual hashtags together */
    }
    
    .hashtags-plain a:hover {
