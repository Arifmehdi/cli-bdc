<style>
    ...
    .mobile-category-title .title-content {
        display: flex;
        align-items: center;
    }
    ...
    .mobile-category-title .arrow-icon {
        transition: transform 0.3s ease;
    }

    .mobile-category-title.active .arrow-icon {
    ...
    .mobile-category-group.active .mobile-category-items {
        max-height: 1000px;
        padding: 8px;
    }
