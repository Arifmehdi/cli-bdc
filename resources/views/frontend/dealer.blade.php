...
$conditions = ['Certified','Preowned','New'];
            ...
            <div style="background:black; border:none;  box-shadow: none;" class="modal-header">
                ...
                <div style="display:flex;">
                    <div style="width:50px; margin-right:15px">
                        <img id="comIcon" style="width:100%" alt="Used cars for sale Best Dream car dealer com icon image"/>
                    </div>
                    <div>
            ...
            <div class="auto-page-image" style="margin-top:40px; margin-left:20%">
                ...
                @isset($banners->image)
                    <img style="width:728px; height:90px;" src="{{ asset('/dashboard/images/banners/' . $banners->image) }}"
                        alt="Used cars for sale dealer dealer auto top page  banner image dream best" />
                @else
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-3 col-md-12 auto-filter-sidebar">
                    <div class="card">
                        <div style="height:86px" class="card-body">
                            <div class="input-group">
                                ...
                                <div class="">
                                    <button style="background:darkcyan; color:white" type="button"
                                        class="btn  br-ts-0  br-bs-0 mb-3" id="webSearchBtn">
                                        Search
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div style="background:rgb(244, 245, 245); border:1px solid rgb(206, 206, 206); height:150px; border-radius:3px"
                                id="confirmationToggleWeb" class="d-none mb-5 open-close-all">

                                <div class="ps-3 pe-2 pb-4 pt-2">
                                    ...
                                    <button
                                        ...
                                        class="btn mb-5 me-1">Clear All</button>
                        ...
                        {{--<div class="card-body">
                            <div style="display: flex; gap: 10px;" class="mb-2">
                                <div style="flex: 1; display: flex; flex-direction: column;">
                                    ...
                                    <select class="form-control makeData select2" name="model">
                                        <option value="">Any</option>
                                        <option value="">10 miles</option>
                                        <option value="">25 miles</option>
                                        <option value="">50 miles</option>
                                        <option value="">75 miles</option>
                                        <option value="" selected>100 miles</option>
                                    </select>
                                </div>
                                <div style="flex: 1; display: flex; flex-direction: column;">
                                    <label for="web_location">Zip Code</label>
                                    <input class="form-control common_selector" id="web_location" type="text"
                                        placeholder="Zip Code" value="{{ $cookie_zipcode ?? ''  }}">
                                </div>
                            </div>
                        ...
                        <div class="card-body w-100">
                            ...
                            <label class="mb-2 custom-control custom-checkbox">
                                <input type="checkbox"
                                    ...
                                    name="checkboxNew" value="{{$condition}}" {{$webConditionChecks[$condition] }}>
                            ...
                            @endforeach
                                {{-- <label class="custom-control custom-checkbox mb-2">
                                    <input type="checkbox" class="custom-control-input autoWebConditionCheckbox common_selector" name="checkboxNew" value="New">
                                    <span class="custom-control-label">
                                        New
                                    </span>
                                </label>
                                <label class="custom-control custom-checkbox mb-2">
                                    <input type="checkbox" class="custom-control-input autoWebConditionCheckbox common_selector" name="checkboxUsed" value="Preowned">
                                    <span class="custom-control-label">
                                        Used
                                    </span>
                                </label>
                                <label class="custom-control custom-checkbox mb-2">
                                    <input type="checkbox" class="custom-control-input autoWebConditionCheckbox common_selector" name="checkboxCertified" value="Certified">
                                    <span class="custom-control-label">
                                        Certified
                                    </span>
                                </label> --}}
                        ...
                        <div style="width:100%; padding-bottom: 38px; padding-left:27px" class="card-body pe-4 pt-2">

                            <div class="h6 text-center">
                                <input type="text" id="price">
                                <span id="price-range-display">$0 – $100,000+</span>
                            </div>
                        ...
                        <div style="width:100%; padding-bottom: 38px; padding-left:27px" class="card-body  pe-4 pt-2">
                            <div class="h6  text-center">
                                <input type="text" id="price">
                                <span id="mileage-range-display">0 – 150,000+</span>
                            </div>
                        ...
                        <div style="width:100%; padding-bottom: 38px; padding-left:27px" class="card-body  pe-4 pt-2">
                            <div class="h6 text-center">
                                <input type="text" id="price">
                                <span id="year-range-display">1985 – 2024</span>
                            </div>
                    ...
                    <div style="margin-top:-10px" class="container p-0 mb-4">
                        ...
                        <div style="border:none" class="card">
                            <div style="border:none" class="card-body p-0">
                                        ...
                                        <div class="p-3">
                                            <div class="custom-row d-flex flex-wrap justify-content-center">
                                                ...
                                                @foreach ($bodyTypes as $bodyType => $image)
                                                    <input type="checkbox" class="web_body-checkbox" style="display:none" value="{{ $bodyType }}" {{ in_array($bodyType, $webBodyFilter) ? 'checked' : '' }}>
                                                    <div class="custom-col {{ in_array($bodyType, $webBodyFilter) ? 'active' : '' }}">
                                                        <a href="javascript:void(0)" class="common_selector web_shadow-set web_body_type_click" data-Testvalue="{{ $bodyType }}">
                                                            <img src="{{ asset('/frontend/assets/images/' . $image) }}" class="img-fluid pt-3" alt="{{ $bodyType }} Image">
                                                            <p style="text-align:center; margin-top:4px; margin-bottom:0px">{{ $bodyType }}</p>
                                                        </a>
                                                    </div>
                                                @endforeach
                                            </div>
                    ...
                    <div class="card overflow-hidden" style="margin-bottom: 8px">
                            ...
                            <div style="display: flex; flex-wrap: wrap; gap: 10px; width:100%">
                                ...
                                @foreach ($colors as $color)
                                    ...
                                    <a href="javascript:void(0)" style="flex-basis: calc(25% - 10px);"
                                        ...
                                        @if ($color == 'white')
                                            <div class="color-box border" style="background: {{ $color }};">
                                ...
                                <a href="javascript:void(0)" style="flex-basis: calc(25% - 10px);"
                                    ...
                                    <div class="color-box"
                                        ...
                                        <img style="padding-top:1px;" width="25px"
                                            src="{{ asset('/frontend/assets/images/nothing.png') }}" alt="Used cars for sale Best Dream car nothing image"/>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class=" px-4 py-3  border-top">
                            <h4 class="mb-3 mt-4">Price & payment</h4>
                            <div style="display:flex">
                                <div class="input-container">
                                    <span class="dollar-sign">$</span>
                                    <input width="55%" class="form-control me-3 mb-5 dollar-input" type="text"
                                        ...
                                        <div class="filter-product-checkboxs">
                                            ...
                                            @forelse ($vehicles_fuel_other as $fuel_info)
                                                <label class="mb-2 custom-control custom-checkbox">
                                                    ...
                                                    <span class="custom-control-label">
                                                        {{ $fuelDisplayNames[$fuel_info] ?? $fuel_info }}
                                                    </span>
                                                </label>
                                            @empty
                    ...
                    <!-- Sticky Button -->
                    <a href="#"><p class="sticky-button" id="stickyButton" style="margin-bottom: 0px;">Over <span
                    id="web_sticky_btn">Loading...</span> Results</p></a>
        ...
        <div class="modal-dialog modal-fullscreen auto-modal" style="width:100%; padding:0px; margin:0px">
            <div class="modal-content filter-modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close float-right mb-2 mt-1 fw-bold" data-bs-dismiss="modal"
                ...
                <div style="background:rgb(243, 243, 243);" id="confirmationToggle" class="d-none">
                    ...
                    <div class="ps-5 pe-5 pb-5 pt-2">
                        ...
                        <button
                            ...
                            class="btn mb-5">Clear All</button>
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-12">
                                    ...
                                    {{-- <div style="display: flex; gap: 10px;" class="mb-5">
                                        <div style="flex: 1; display: flex; flex-direction: column;">
                                            ...
                                            <select id="searchSecondFilterModelInput"
                                                class="form-control makeData select2" name="model">
                                                <option value="">Any</option>
                                                <option value="">10 miles</option>
                                                <option value="">25 miles</option>
                                                <option value="">50 miles</option>
                                        ...
                                        <div style="flex: 1; display: flex; flex-direction: column;">
                                            ...
                                            <input class="form-control mobile_common_selector" type="text"
                                                id="mobile_location" placeholder="Zip Code"
                                    ...
                                    <div style="padding:0; height:auto;" class="card-body mb-4">
                                        <div class="accordion accordion-flush" id="accordionFlushExample">
                                                        ...
                                                        <div class="filter-product-checkboxs">
                                                            ...
                                                            <label class="mb-2 custom-control custom-checkbox">
                                                                <input type="checkbox"
                                                                    ...
                                                                    name="checkbox" value="{{$condition}}" {{$mobileConditionChecks[$condition] }}>
                                                                <span class="custom-control-label">
                                                                    @if ($condition == 'Preowned')
                                                                        Used
                                                                    @else
                                                            ...
                                                            {{-- <label class="custom-control custom-checkbox mb-2">
                                                                <input type="checkbox"
                                                                    class="custom-control-input autoMobileTypeCheckbox mobile_common_selector"
                                                                    name="checkbox" value="newType"
                                                                    <?php //echo $usedChecked; ?>>
                                                                <span class="custom-control-label">
                                                                    New
                                                                </span>
                                                            </label>
                                                            ...
                                                            <label class="custom-control custom-checkbox mb-2">
                                                                <input type="checkbox"
                                                                    class="custom-control-input autoMobileTypeCheckbox mobile_common_selector"
                                                                    name="checkbox3" value="certifiedType"
                                                                    <?php //echo $certifiedChecked; ?>>
                                                                <span class="custom-control-label">
                                                                    Certified
                                                                </span>
                                                            </label> --}}
                                                ...
                                                <div class="tab-pane fade" id="body-card" role="tabpanel"
                                                    ...
                                                    <div class="p-3 mt-4">
                                                        <div class="custom-row d-flex flex-wrap justify-content-center">
                                                            ...
                                                            @foreach ($bodyTypes as $bodyType => $image)
                                                                <input type="checkbox" class="mobile_body-checkbox" style="display:none" value="{{ $bodyType }}"{{ in_array($bodyType, $mobileBody) ? 'checked' : '' }} >
                                                                <div class="custom-col {{ in_array($bodyType, $mobileBody) ? 'active' : '' }}">
                                                                    <a href="javascript:void(0)" class="common_selector mobile_shadow-set mobile_body_type_click" data-Testvalue="{{ $bodyType }}">
                                                                        <img src="{{ asset('/frontend/assets/images/' . $image) }}" class="img-fluid pt-3" alt="{{ $bodyType }} Image">
                                            ...
                                            <div style="display: flex; flex-wrap: wrap; gap: 10px; width:100%">
                                                ...
                                                <a href="javascript:void(0)" style="flex-basis: calc(25% - 10px);"
                                                    ...
                                                    <div class="color-box"
                                                        style="background: white; border-radius: 3px; text-align:center; border:1px solid rgb(219, 219, 219)">
                                                        <img style="padding-top:1px;" width="25px"
                                                            src="{{ asset('/frontend/assets/images/nothing.png') }}" alt="Used cars for sale Best Dream car nothing second image"/>
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="filter-product-checkboxs">
                                                            <label class="custom-control custom-checkbox mb-2">
                                                                <input type="checkbox"
                                                                    ...
                                                                    id="selectAllTranscissionCheckbox"
                                                                    <?php echo $allChecked; ?>>
                                                                <span class="custom-control-label">
                                                                    All
                                                                </span>
                                                            ...
                                                            <label class="custom-control custom-checkbox mb-2">
                                                                <input type="checkbox"
                                                                    class="custom-control-input autoMobileTransmissionCheckbox mobile_common_selector"
                                                                    name="checkbox12" value="Manual"
                                                                    <?php echo $manualChecked; ?>>
                                                                <span class="custom-control-label">
                                                                    Manual
                                                                </span>
                                                            </label>
                                    ...
                                    <div style="padding: 0; height: auto; margin-bottom: 15px" class="card-body">
                                        <div class="accordion accordion-flush" id="accordionFlushExample">
                                            <div class="accordion-item">
                                                ...
                                                <div style="border-left: 1px solid rgb(206, 205, 205); border-right: 1px solid rgb(206, 205, 205); border-bottom: 1px solid rgb(206, 205, 205); "
                                                    id="flush-collapseOne-drivetrain"
                                                    class="accordion-collapse collapse"
                                                    aria-labelledby="flush-headingOne"
                                                    data-bs-parent="#accordionFlushExample">
                                                            ...
                                                            @foreach ($driveTrains as $driveTrain)
                                                                <label class="custom-control custom-checkbox mb-2">
                                                                    <input type="checkbox"
                                                                        ...
                                                                        value="{{ $driveTrain }}" {{ $webDriveTrainChecks[$driveTrain] }}>
                                                                    <span class="custom-control-label">{{ $driveTrain }}</span>
                                                                </label>
                                                            @endforeach
                                                        </div>
                                    ...
                                    <div style="padding:0; height:auto; margin-bottom: 15px" class="card-body mb-4">
                                        <div class="accordion accordion-flush" id="accordionFlushExample">
                                            <div class="accordion-item">
...
//   *****************mobile body search ajax code start here  **********************************************************
    ...
    @include('frontend.website.layout.js.dealer_list_js')
