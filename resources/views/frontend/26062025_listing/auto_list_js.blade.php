        ...
        function pageLoad(page = 1) {
            ...
            $(document).ready(function() {
                ...
                function createSkeletonLoader(count) {
                    var skeletonHtml = '<div class="skeleton-loader">';
                ...
                // Remove existing loader and add skeleton
                if ($('#loading').length) {
                    $('#loading').remove();
                }
                $('#auto_ajax').html(createSkeletonLoader(12)); // Show 3 skeleton cards
                ...
                if (screenWidth < 1000) {
                    $('#auto_ajax').html(createSkeletonLoader(12));
                    ...
                    var selected_sort_search = $('#mobile_selected_sort_search_data').val();
...
alert(selected_sort_search);
        ...
        $(document).on('click', '.pagination a', function(e) {
            e.preventDefault();
            // Scroll to top BEFORE Ajax load
        ...
        $(document).on('change', '#mobile_selected_sort_search_data', function() {
            pageLoad();
        });
