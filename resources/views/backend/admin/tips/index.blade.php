...
<div class="row">
    ...
    {{-- add user modal --}}
    <div class="modal fade" id="tipsAddModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.tips.add') }}" method="post" id="tipsAddForm"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="title">Tips Title <span style="color: red; font-weight:bold">*</span></label>
                            <input type="text" class="form-control" name="title" id="title"
                                placeholder="Enter Your Title">
                            <span class="text-danger error-message" id="title-error"></span>
                        </div>
                        <div class="form-group">
                            <label for="title">Tips By </label>
                        ...
                        <div class="form-group">
                            <label for="title">Tips Owner Title</label>
                        ...
                        <div class="mt-4 form-group">
                            <label for="image">Tips Image</label>
                        ...
                        <button type="submit"
                            ...
                            class="btn btn-success" id="tips_submit_button">Submit</button>
                    </form>
                </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="tipsEditModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="tipsEditFrom" action="{{ route('admin.tips.update') }}" method="POST"
                        class="mt-2 form-horizontal sales-form" enctype="multipart/form-data">
                        @csrf


                        <input type="hidden" name="tips_id" id="tips_id">
        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Tips List</h3>
                    <a href="" class="float-right btn btn-primary btn-sm" data-toggle="modal"
                        data-target="#tipsAddModal"> <i class="fas fa-plus-circle"></i> Add Tips</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">

                    <table class="table table-bordered table-striped tips_table">
                        <thead>
                            <tr>
                                <th>SL</th>
                                <th>Image</th>
...
ClassicEditor
    ...
    .catch(error => {
        ...
        $(document).ready(function() {
            ...
            $(document).on('submit', '#tipsAddForm', function(e) {
                e.preventDefault();
                
                var formData = new FormData($(this)[0]);
                $('#tips_submit_button').text('Loading...');
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        if (res.errors) {
                            ...
                            $('#tips_submit_button').text('Submit');
                        }

                        if (res.status === 'success') {
                            
                            $('.tips_table').DataTable().draw(false);
            ...
            // news delete
            $(document).on('click', "#tips_delete", function(e) {
                e.preventDefault();
                let id = $(this).data('id');
                $.confirm({
            ...
            $(document).on('click', '.tipsEditBtn', function(e) {
                e.preventDefault();
                ...
                $('.imagePreview').attr('src', "{{ asset('/frontend/assets/images/tips') }}" + '/' + image);
            ...
            // news edit code
            $(document).on('submit', '#tipsEditFrom', function(e) {
                e.preventDefault();
            ...
            $(document).on('change', '.action-select', function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin.tips.status.change') }}",
                    method: "post",
                    data: {
                        id: id
                    },
