                ...
                <div class="modal-body">
                    <form action="{{ route('admin.blogs.create') }}" method="post" id="newsAdd"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="hashKeyword">Hash Keyword</label>
                                    <textarea name="hashKeyword" class="form-control" id="hashKeyword"></textarea>
                                    <!-- <div id="hash_keyword"></div> -->

                                    <!-- <input type="hidden" name="hash_keyword[]" id="hiddenHashKeyword"> -->
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    <form id="NewsEditFrom" action="{{ route('admin.blogs.update') }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="up_hashKeyword">Hash Keyword</label>
                                    <textarea name="up_hashKeyword" class="form-control" id="up_hashKeyword"></textarea>
                                    <!-- <div id="hash_keyword"></div> -->
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="" class="float-right btn btn-primary btn-sm" data-toggle="modal"
                        data-target="#blogssAddModal"> <i class="fas fa-plus-circle"></i> Add Blog</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
...
$(document).on('click', '.editBtn', function(e) {
    ...
    let hash_keyword = $(this).data('hash_keyword');
    ...
    $('#up_hashKeyword').val(hash_keyword);
