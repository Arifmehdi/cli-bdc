            ...
            <div class="col-md-5">
                <div class="card">
                    <div class="card-header" id="creatModal">
                        <h3 class="card-title" id="header-title">Add Vehicle Make</h3><br>
                        <hr>
                        <form action="{{route('admin.makes.store')}}" method="post" id="userForm">
                            @csrf

                            <div class="form-group">
                                <label for="make">Make Name</label>
                                <input type="text" class="form-control" name="make_name" id="createmake"
            ...
            <div class="col-md-7">
                ...
                <div class="card">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table  class="table table-bordered table-striped make-table table-responsive">
                                <thead>
                                    <tr>
                                        <th>
                                            <div>
...
$(document).ready(function() {
    $(function() {
        ...
        var table = $('.make-table').DataTable({
...
function dataStore() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $('.make-table').DataTable().draw(false);
        ...
        error: function(error) {
            ...
            if (errors && errors.make) {
                $('#make-error').text(errors.make_name[0]);
...
function addform()
{
    var html = '<h3 class="card-title" id="header-title">Add Vehicle Make</h3><br><hr>' +
            ...
            '<div class="form-group">' +
            '<label for="make">Make Name</label>' +
            '<input type="text" class="form-control" name="make_name" id="createmake" placeholder="Enter Your Make">' +
            '<span class="text-danger error-message" id="make-error"></span>' +
            '</div>' +
            '<div class="form-group">' +
            '<label for="status">Status : </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' +
    ...
    $(document).on('click', '.delete', function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "{{ route('admin.makes.destroy', '') }}" + '/' + id,
                    type: 'DELETE',
                    data: {
                        id: id
                    },
        ...
        $.ajax({
                ...
                success: function(res) {
                    ...
                    var html = '<h3 class="card-title" id="header-title">Edit Vehicle Make</h3><br><hr>' +
                        ...
                        '<div class="form-group">' +
                        '<label for="make">Make Name</label>' +
                        '<input type="text" class="form-control" name="make_name" id="editMake" placeholder="Edit Your Make" value="'+res.makeData+'">' +
