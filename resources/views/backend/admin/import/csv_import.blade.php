            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Add CSV Import</h3><br>
                        <hr>
                        ...
                        <form id="file-upload-form" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
                            ...
                            <label for="file-upload" id="file-drag">
                                ...
                                <br /><br /><span id="file-upload-btn" class="button">Add CSV file</span>
                            </label>
...
$(document).ready(function() {
    $(function() {
        ...
        var table = $('.contact_table').DataTable({
            ...
            searchable: true,
            "ajax": {
                "url": "{{ route('admin.csv-management.index') }}",
                "datatype": "json",
                "dataSrc": "data",
                "data": function(data) {
        ...
        buttons: {
            ...
            confirm: {
                ...
                action: function () {
                    ...
                    $.ajax({
                        url: "{{ route('admin.csv-management.delete') }}",
                        type: 'post',
                        data: {
                            id: id
                        },
    ...
    $(document).ready(function() {
        ...
        $('#import-btn').on('click', function() {
            ...
            if (file) {
                ...
                $.ajax({
                    url: "{{ route('admin.csv-management.upload') }}", // Adjust to your route
                    type: 'POST',
                    data: formData,
