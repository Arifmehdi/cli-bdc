            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Add Bulk Dealer</h3><br>
                        <hr>
                        <form action="{{route('admin.dealer.csv.store')}}" method="post" enctype="multipart/form-data">
                            @csrf
                    ...
                    if (response.status === 'success') {
                        ...
                        Swal.fire({
                            ...
                            html: `
                                ...
                                <ul>
                                    <li><a href="/uploads/dealer/imported_dealers.txt" target="_blank">Imported Dealers</a></li>
                                    <li><a href="/uploads/dealer/not_imported_dealers.txt" target="_blank">Not Imported Dealers</a></li>
                                    <li><a href="/uploads/dealer/updated_dealers.txt" target="_blank">Updated Dealers</a></li>
                                </ul>
                            `,
                            icon: 'info',
