                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <form id="file-upload-form" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
                            ...
                            <!-- Progress Bar -->
                            <progress id="file-progress" value="0" max="100" style="width: 100%; display: none;"></progress>
    ...
    $(document).ready(function() {
        $('#import-btn').on('click', function() {
            ...
            if (file) {
                ...
                $('#file-progress').attr('value', 0).show();
                $('#progress-text').text('0%');

                // Disable button and show loading text
                $('#import-btn').prop('disabled', true).html('Importing...');
                ...
                $.ajax({
                    ...
                    xhr: function() {
                        ...
                        xhr.upload.addEventListener("progress", function(evt) {
                            if (evt.lengthComputable) {
                                ...
                                $('#file-progress').attr('value', percentComplete); // Update progress bar
                                $('#progress-text').text(percentComplete + '%'); // Show percentage
                            }
                        }, false);
                        return xhr;
                    },
                    success: function(response) {
                        ...
                        // Reset UI
                        $('#file-upload').val('');
                        $('#file-progress').attr('value', 0).hide();
                        $('#progress-text').text('');
                        $('#import-btn').hide().prop('disabled', false).text('Import');
     ...
     //  // import btn without progress start here
        // $(document).ready(function() {
        //     $('#import-btn').on('click', function() {
        //         var formData = new FormData();
        //         var fileInput = $('#file-upload')[0];
        ...
        //     });
        // });
     //  // import btn without progress end  here


    // // import btn without btn loading start here
        // $(document).ready(function() {
        ...
        //     });
        // });
    // // import btn without btn loading end here
})();
</script>
