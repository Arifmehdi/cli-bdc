            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Add Bulk Location</h3><br>
                        <hr>
                        <form action="{{route('admin.location.csv.store')}}" method="post" enctype="multipart/form-data">
                            @csrf
...
<script>
    $(document).ready(function() {
        $('#uploadButton').on('click', function(e) {
            ...
            $.ajax({
                url: "{{ route('admin.location.csv.store')}}",
                type: "POST",
                data: formData,
                headers: {
...
$(document).ready(function() {
    $(function() {
        ...
        var table = $('.contact_table').DataTable({
            ...
            {
                data: 'location_state_short',
                name: 'location_state_short',
                width: "20%",
            },
            {
                data: 'latitude',
