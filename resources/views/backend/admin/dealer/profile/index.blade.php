   ...
   {{-- send lead email modal start --}}
    ...
    <section class="content">
        <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                <li class="nav-item"><a class="nav-link active" href="#">Listing</a></li>
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="active" id="listing">

                                    <form id="bulk_action_form" action="{{ route('admin.inventory.bulk-action') }}"
                                        method="POST">
                                        @csrf
         ...
         <!-- Delete Form -->
    <form id="dealer_delete_form" action="" method="post">
        @method('DELETE')
        @csrf
    </form>
...
<script>
        ...
        $(document).on('click', '#dealer_trashed_item', function(e) {
            e.preventDefault();
            $(this).attr("showtrash", true);
            $('.check1').prop('checked', false)
            $(this).addClass("font-weight-bold");
            ...
            $('#lead_delete_all_item').removeClass("font-weight-bold");
            $("#lead_delete_option").css('display', 'block');
            $("#lead_restore_option").css('display', 'block');
            $("#lead_move_to_trash").css('display', 'none');
        })

        $(document).on('click', '#lead_delete_all_item', function(e) {
            e.preventDefault();
            dealer_trashed_item = $('#dealer_trashed_item');
            $('#lead_check_all').prop('checked', false);
            $('.check1').prop('checked', false);
            dealer_trashed_item.attr("showtrash", false);
            $(this).addClass("font-weight-bold");
            $('.lead_table').DataTable().draw(false);
            $('#dealer_trashed_item').removeClass("font-weight-bold")
